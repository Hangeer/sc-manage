...
<template>
  <section class="album">
    <p class="bg-info title">轮播图管理界面</p>
    
    <div class="new-live">
      <p class="bg-success title">首页轮播</p>
      <div class="input-group" v-for="item in home">
    ...
    <div class="new-live">
      ...
      <div class="input-group" v-for="item in activity">
        <span class="input-group-addon">{{item.id}}</span>
        <input type="text" class="form-control" v-model="item.url">
      </div>
    </div>
